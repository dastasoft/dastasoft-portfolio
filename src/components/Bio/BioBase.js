    ...
    <section className={className}>
      ...
      <div>
        <p>
          ...
          full-stack developer with 10 years of experience in technologies such
          as JavaScript, React and Java. My ability to work on both front-end
          and back-end development, paired with my experience in medium and big
          companies as well as startups, allows me to create dynamic and
          user-friendly applications and systems.
        </p>
        <p>
